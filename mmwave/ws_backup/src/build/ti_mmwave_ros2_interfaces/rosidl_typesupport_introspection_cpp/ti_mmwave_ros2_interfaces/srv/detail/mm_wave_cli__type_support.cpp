...
{
  new (message_memory) ti_mmwave_ros2_interfaces::srv::MMWaveCLI_Request(_init);
}

void MMWaveCLI_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ti_mmwave_ros2_interfaces::srv::MMWaveCLI_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MMWaveCLI_Request_message_member_array[1] = {
  {
    ...
    offsetof(ti_mmwave_ros2_interfaces::srv::MMWaveCLI_Request, comm),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MMWaveCLI_Request_message_members = {
  "ti_mmwave_ros2_interfaces::srv",  // message namespace
  "MMWaveCLI_Request",  // message name
  1,  // number of fields
  sizeof(ti_mmwave_ros2_interfaces::srv::MMWaveCLI_Request),
...
{
  return &::ti_mmwave_ros2_interfaces::srv::rosidl_typesupport_introspection_cpp::MMWaveCLI_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ti_mmwave_ros2_interfaces, srv, MMWaveCLI_Request)() {
  return &::ti_mmwave_ros2_interfaces::srv::rosidl_typesupport_introspection_cpp::MMWaveCLI_Request_message_type_support_handle;
}
...
void MMWaveCLI_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) ti_mmwave_ros2_interfaces::srv::MMWaveCLI_Response(_init);
}

void MMWaveCLI_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ti_mmwave_ros2_interfaces::srv::MMWaveCLI_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MMWaveCLI_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ti_mmwave_ros2_interfaces::srv::MMWaveCLI_Response, resp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MMWaveCLI_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(ti_mmwave_ros2_interfaces::srv::MMWaveCLI_Response),
...
{
  return &::ti_mmwave_ros2_interfaces::srv::rosidl_typesupport_introspection_cpp::MMWaveCLI_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ti_mmwave_ros2_interfaces, srv, MMWaveCLI_Response)() {
  return &::ti_mmwave_ros2_interfaces::srv::rosidl_typesupport_introspection_cpp::MMWaveCLI_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers MMWaveCLI_service_members = {
  "ti_mmwave_ros2_interfaces::srv",  // service namespace
  "MMWaveCLI",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<ti_mmwave_ros2_interfaces::srv::MMWaveCLI>()
...
get_service_type_support_handle<ti_mmwave_ros2_interfaces::srv::MMWaveCLI>()
{
  ...
  auto service_type_support =
    &::ti_mmwave_ros2_interfaces::srv::rosidl_typesupport_introspection_cpp::MMWaveCLI_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ti_mmwave_ros2_interfaces, srv, MMWaveCLI)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<ti_mmwave_ros2_interfaces::srv::MMWaveCLI>();
}
