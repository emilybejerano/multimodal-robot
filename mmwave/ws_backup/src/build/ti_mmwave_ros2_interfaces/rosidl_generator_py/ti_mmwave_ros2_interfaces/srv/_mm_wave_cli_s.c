...
bool ti_mmwave_ros2_interfaces__srv__mm_wave_cli__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ti_mmwave_ros2_interfaces.srv._mm_wave_cli.MMWaveCLI_Request", full_classname_dest, 60) == 0);
  }
  ti_mmwave_ros2_interfaces__srv__MMWaveCLI_Request * ros_message = _ros_message;
  {  // comm
...
PyObject * ti_mmwave_ros2_interfaces__srv__mm_wave_cli__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ti_mmwave_ros2_interfaces.srv._mm_wave_cli");
...
ROSIDL_GENERATOR_C_EXPORT
bool ti_mmwave_ros2_interfaces__srv__mm_wave_cli__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ti_mmwave_ros2_interfaces.srv._mm_wave_cli.MMWaveCLI_Response", full_classname_dest, 61) == 0);
  }
  ti_mmwave_ros2_interfaces__srv__MMWaveCLI_Response * ros_message = _ros_message;
  {  // resp
