...
#ifndef TI_MMWAVE_ROS2_INTERFACES__SRV__DETAIL__MM_WAVE_CLI__FUNCTIONS_H_
#define TI_MMWAVE_ROS2_INTERFACES__SRV__DETAIL__MM_WAVE_CLI__FUNCTIONS_H_
...
#include "ti_mmwave_ros2_interfaces/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_ti_mmwave_ros2_interfaces
bool
 ...
 * calls
 * ti_mmwave_ros2_interfaces__srv__MMWaveCLI_Request__init().
...
/**
 * It calls
 * ti_mmwave_ros2_interfaces__srv__MMWaveCLI_Request__fini()
 ...
 * ti_mmwave_ros2_interfaces__srv__MMWaveCLI_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ti_mmwave_ros2_interfaces__srv__MMWaveCLI_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ti_mmwave_ros2_interfaces__srv__MMWaveCLI_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ti_mmwave_ros2_interfaces
...
/**
 * It calls
 * ti_mmwave_ros2_interfaces__srv__MMWaveCLI_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ti_mmwave_ros2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ti_mmwave_ros2_interfaces__srv__MMWaveCLI_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ti_mmwave_ros2_interfaces
...
/**
 * It calls
 * ti_mmwave_ros2_interfaces__srv__MMWaveCLI_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TI_MMWAVE_ROS2_INTERFACES__SRV__DETAIL__MM_WAVE_CLI__FUNCTIONS_H_
