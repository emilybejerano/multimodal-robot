...
#include "ti_mmwave_ros2_interfaces/msg/detail/radar_scan__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_ti_mmwave_ros2_interfaces
...
using _RadarScan__ros_msg_type = ti_mmwave_ros2_interfaces__msg__RadarScan;
...
size_t get_serialized_size_ti_mmwave_ros2_interfaces__msg__RadarScan(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RadarScan__ros_msg_type * ros_message = static_cast<const _RadarScan__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RadarScan__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ti_mmwave_ros2_interfaces__msg__RadarScan(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ti_mmwave_ros2_interfaces
size_t max_serialized_size_ti_mmwave_ros2_interfaces__msg__RadarScan(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _RadarScan__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ti_mmwave_ros2_interfaces__msg__RadarScan(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_RadarScan = {
  "ti_mmwave_ros2_interfaces::msg",
  "RadarScan",
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ti_mmwave_ros2_interfaces, msg, RadarScan)() {
