...
#include "ti_mmwave_ros2_interfaces/msg/detail/radar_scan__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ti_mmwave_ros2_interfaces::msg::RadarScan & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ti_mmwave_ros2_interfaces::msg::RadarScan & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const ti_mmwave_ros2_interfaces::msg::RadarScan *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ti_mmwave_ros2_interfaces::msg::RadarScan *>(
    untyped_ros_message);
...
{
  return max_serialized_size_RadarScan(full_bounded, 0);
}
...
{
  return &ti_mmwave_ros2_interfaces::msg::typesupport_fastrtps_cpp::_RadarScan__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ti_mmwave_ros2_interfaces, msg, RadarScan)() {
  return &ti_mmwave_ros2_interfaces::msg::typesupport_fastrtps_cpp::_RadarScan__handle;
}
