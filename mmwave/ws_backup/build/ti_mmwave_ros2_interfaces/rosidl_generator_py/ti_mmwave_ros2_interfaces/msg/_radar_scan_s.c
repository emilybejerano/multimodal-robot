...
bool ti_mmwave_ros2_interfaces__msg__radar_scan__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ti_mmwave_ros2_interfaces.msg._radar_scan.RadarScan", full_classname_dest, 51) == 0);
  }
  ti_mmwave_ros2_interfaces__msg__RadarScan * ros_message = _ros_message;
  {  // header
...
PyObject * ti_mmwave_ros2_interfaces__msg__radar_scan__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ti_mmwave_ros2_interfaces.msg._radar_scan");
